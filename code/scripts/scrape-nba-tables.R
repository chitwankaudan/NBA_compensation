...
for (i in 1:total_teams) {
    ...
    write.csv(roster,
              file = paste0('data/rawdata/roster-data/roster-', team_names[i], '.csv'))
    ...
    write.csv(totals,
              file = paste0('data/rawdata/stat-data/stats-', team_names[i], '.csv'))
    ...
    write.csv(salaries,
              file = paste0('data/rawdata/salary-data/salaries-', team_names[i], '.csv'))
